    ...
    <>
      ...
      <main className="container">
        ...
        <section className="section card">
          ...
          <p className="muted">
            TimeCam is an AI-powered application that generates artistic, illustrative, and speculative images and
            videos inspired by historical periods, locations, or speculative timelines based on user-provided photos
            and inputs.
          </p>
        ...
        <section className="section card">
          <h2>3. AI-Generated Content Disclaimer &amp; Output Licence</h2>
          ...
          <ul className="list">
            ...
            <li>TimeCam is not responsible for decisions made based on AI-generated outputs</li>
          </ul>
          <p className="muted">
            Unless otherwise stated, TimeCam grants you a personal, non-exclusive licence to use AI-generated content
            for personal and commercial purposes, provided such use does not misrepresent the content as factual,
            historical, or documentary in nature.
          </p>
        </section>
        ...
        <section className="section card">
          ...
          <p className="muted">
            TimeCam reserves the right to modify credit pricing, subscription tiers, features, or availability at any
            time. Continued use of the app constitutes acceptance of such changes.
          </p>
          <p className="muted">
        ...
        <section className="section card">
          ...
          <p className="muted">
            By using TimeCam, you grant us a limited, non-exclusive, royalty-free licence to process your content solely
            for the purpose of operating, maintaining, and improving the app.
          </p>
        </section>
        ...
        <section className="section card">
          ...
          <ul className="list">
            ...
            <li>Abuse, exploit, or attempt to bypass app features, credits, or systems</li>
          </ul>
        </section>
        ...
        <section className="section card">
          ...
          <p className="muted">
            We may suspend or terminate access to TimeCam at our discretion, including for suspected abuse, misuse, or
            attempts to circumvent systems, with or without notice, where permitted by law.
          </p>
        </section>
        ...
        <section className="section card">
          ...
          <p className="muted">
            To the maximum extent permitted by law, TimeCam’s total liability shall not exceed the amount paid by you
            for the app or subscriptions in the preceding twelve (12) months.
          </p>
        </section>
        ...
        <section className="section card">
          ...
          <p className="muted">
            This EULA is governed by applicable local consumer protection laws and, where permitted, the laws of England
            and Wales.
          </p>
        </section>
